 ...
 * 
 */
public class ServiceTest2_activity_PlayMusic extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		int op = -1;
		Intent intent = new Intent("com.android.service.ServiceTest2_service_MusicService");
